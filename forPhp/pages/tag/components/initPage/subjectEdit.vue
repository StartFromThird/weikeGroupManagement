  ...
  <div class="page">
    <div class="page-head">
      ...
      <el-popover placement="right" trigger="hover">
        ...
        <img class="tip" slot="reference" src="../../static/image/info.png" />
      </el-popover>
    </div>
            ...
            <el-col :sm="24" :md="12" :lg="12">
              ...
              <template v-if="isQW">
                ...
                <div class="flex-row-end">
                  <el-button size="mini" @click="routeTo">取消</el-button>
      ...
      <template v-else-if="pageType === 'edit'">
        <div class="edit-info">
          <div class="edit-info-head">
            <img v-if="isQW" class="img" src="../../static/image/qywx@2x.png" alt="企微" />
            <div class="txt">{{ `${info.headTxt}@${info.sub_name}` }}</div>
          </div>
              ...
              <div class="preview-info">
                ...
                <div class="preview-list">
                  ...
                  <template v-for="(item, index) of tableData">
                    <div class="preview-item" :key="index" v-if="item.name">
...
.page-main .page-main-step .page-main-step-index {
  width: 20px;
  height: 20px;
  line-height: 20px;
  border-radius: 50%;
...
.page-main .edit-key-wrap {
  display: flex;
}
.operate-box {
  width: 100%;
}
.operate-box .operate-box-item {
  width: 25%;
}
.mt-20 {
  margin-top: 20px;
}
.edit-info .edit-info-head {
  display: flex;
  align-items: center;
  margin-bottom: 12px;
}
.edit-info .edit-info-head .img {
  width: 26px;
  height: 26px;
  margin-right: 12px;
}
.edit-info .edit-info-head .txt {
  font-size: 22px;
  font-weight: 500;
  text-align: left;
  color: #171717;
...
.edit-info .edit-info-row {
  display: flex;
  margin-bottom: 8px;
}
.edit-info .edit-info-row .edit-info-txt {
  min-width: 400px;
}
.edit-info .edit-info-txt {
  font-size: 14px;
  font-weight: 400;
  text-align: left;
...
.preview-info .preview-header .phone-header {
  width: 100%;
}
...
.preview-header .user-info .user-detail {
  display: flex;
  align-items: center;
  margin-bottom: 15px;
}
.preview-header .user-info .user-detail .baseWechatColor1 {
  color: #00c000;
}
.preview-header .user-info .user-detail .baseqyWechatColor1 {
  color: #ff6f00;
}
.preview-header .user-info .preview-avatr {
  width: 40px;
  height: 40px;
  margin-right: 8px;
  border-radius: 5px;
...
.preview-header .user-info .nickname {
  font-size: 12px;
  font-weight: bold;
  color: #171717;
  margin-right: 4px;
...
.preview-header .user-info .sex-icon {
  width: 10px;
  height: 10px;
  margin-left: 4px;
}

.preview-header .user-info .company-name {
  font-size: 10px;
}
...
.preview-list .preview-item .preview-item-left {
  font-size: 10px;
  color: #171717;
  line-height: 14px;
  width: 106px;
...
.preview-list .preview-item .preview-item-right {
  font-size: 10px;
  font-weight: bold;
  color: #171717;
  line-height: 14px;
