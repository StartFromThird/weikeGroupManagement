<template>
  <div class="page subject-list-detail">
    ...
    <div class="page-main page-main-no-scroll bg-grey">
      <div class="search-bar">
        <div class="search-field-item">
          <div class="search-field-item-label">字段名称：</div>
          <el-select
...
.subject-list-detail .page-head {
  display: flex;
  align-items: center;
  height: 58px;
}

.subject-list-detail .page-head .page-head-txt {
  font-size: 20px;
...
.subject-list-detail .page-main {
  flex: 1;
  box-sizing: border-box;
  overflow-y: auto;
}

.subject-list-detail .page-main-no-scroll {
  display: flex;
  flex-direction: column;
...
.subject-list-detail .bg-grey {
  background: rgba(0, 0, 0, 0.04);
}

.subject-list-detail .page-main .search-bar {
  display: flex;
...
.subject-list-detail .page-main .search-bar .search-field-item {
  display: flex;
  align-items: center;
}

.subject-list-detail .page-main .search-bar .search-field-item .search-field-item-label {
  font-size: 14px;
  font-weight: 400;
  text-align: left;
  color: #000000;
...
.subject-list-detail .page-main .search-bar .search-field-item .search-field-value {
  width: 320px;
  margin-left: 8px;
}

.subject-list-detail .page-main .search-bar .search-btn-group {
  white-space: nowrap;
}

.subject-list-detail .page-main .table-wrap {
  flex: 1;
  display: flex;
  flex-direction: column;
  overflow: hidden;
...
.subject-list-detail .page-main .table-wrap .table-head {
  height: 64px;
  align-items: center;
  padding: 0 24px;
}

.subject-list-detail .page-main .table-wrap .table-head .table-head-txt {
  font-size: 16px;
  font-weight: 500;
  text-align: left;
  color: #000000;
...
.subject-list-detail .page-main .table-wrap .table-main {
  flex: 1;
  padding: 0 24px;
}

.subject-list-detail .table-pagination-wrap {
